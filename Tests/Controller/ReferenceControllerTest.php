...
use Claroline\ForumBundle\Tests\DataFixtures\LoadReferenceData;
...
class ReferenceControllerTest extends FunctionalTestCase
{
    ...
    public function testSubjects()
    {
        ...
        $this->loadFixture(new LoadReferenceData('test', 'user', 0, 0));
    ...
    public function testMessages()
    {
        ...
        $this->em->flush();
        $this->loadFixture(new LoadReferenceData('test', 'user', 2, 2));
        $this->logUser($this->getUser('user'));
        $crawler = $this->client
            ->request('GET', "/forum/{$this->getFixtureReference('forum/test')->getId()}/offset/0");
